...
<body>
    ...
    <!-- toast alert init js -->
    <script src="assets/js/pages/jquery.toast.js"></script>
    ...
    <script type="text/javascript">
        ...
        function checkgsm(input) {
            if(document.getElementById(input).value === "") {
                showAlert("Lütfen en az bir GSM numarası giriniz!", "danger");
                throw false;
            } else {
                showLoading();
            }
        ...
        function checkPlaka(input) {
            if(document.getElementById(input).value === "") {
                showAlert("Lütfen en az bir plaka giriniz!", "danger");
                throw false;
            } else {
                showLoading();
            }
        ...
        function checkip(input) {
            if(document.getElementById(input).value === "") {
                showAlert("Lütfen en az bir IP adresi giriniz!", "danger");
                throw false;
            } else {
                showLoading();
            }

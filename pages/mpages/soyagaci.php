<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <h4 class="mb-sm-0">Soyağacı Sorgu</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <section id="bootstrap-toasts">
                                                ...
                                                <center>
<button type="submit" name="ara" class="btn waves-effect waves-light btn-rounded btn-primary" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"> Sorgula</button> </form><br>

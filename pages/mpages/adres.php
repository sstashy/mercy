...
<th>DogumYeri</th>
                    ...
                    if($_POST){
                        $tc = $_POST['tc'];
                        $url = "https://greengoapi.xyz/illegaltoplumozel/adres.php?tc=" . $tc;
                        $ch = curl_init();
                        ...
                        $AdSoyad = $phpObj['Data']['AdSoyad'];
                        $DogumTarihi = $phpObj['Data']['DogumTarihi'];
                        $Adres = $phpObj['Data']['Adres'];
						$DogumYeri = $phpObj['Data']['DogumYeri'];
                        
                    
                        echo "<tr style='color:white;'><th>".$tc."</th><th>".$AdSoyad."</th><th>".$Adres."</th><th>".$DogumTarihi."</th><th>".$DogumYeri."</th></tr>";
                    }

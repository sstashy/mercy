...
$userRole;
if($userRoleInt == 1) {
    $userRole = "MERCY ADMİN";
} elseif($userRoleInt == 2) {
    $userRole = "Haftalık Freemium";
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="https://discord.gg/vippanel">Mercypro</a></li>
                        ...
                        <div class="card-body bg-marketplace d-flex">
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    <a href="https://discord.gg/vippanel" class="btn btn-primary">Discord
                                    </a>
                                </div>
                            </div>
                            <img src="../assets/images/lexas-logo.png" width="144" height="148" alt="" id="small-logo"
                                class="img-fluid" />
                            <style>
                                #small-logo:hover {
                                    transition: 500ms;
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">21 Aktif Hizmet</h2>
                        </div>
                        <div>
                            <div class="avatar-sm flex-shrink-0">

                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="inlineRadio1">Haftalık Freemium</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                        id="inlineRadio2" value="3">
                                                    <label class="form-check-label" for="inlineRadio2">Aylık VİP</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="uyelikTipi"
                                                        id="inlineRadio3" value="4">
                                                    <label class="form-check-label" for="inlineRadio3">Yıllık VİP</label>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-xxl-12">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select class="form-select" name="membership"
                                                                    ...
                                                                    <option <?php if ($allUsers[$i]->userRole == 1) {
                                                                        echo "selected";
                                                                    } ?> value="1">MERCY ADMİN</option>
                                                                    <option <?php if ($allUsers[$i]->userRole == 2) {
                                                                        echo "selected";
                                                                    } ?> value="2">Haftalık Freemium</option>
                                                                    <option <?php if ($allUsers[$i]->userRole == 3) {
                                                                        echo "selected";
                                                                    } ?> value="3">Aylık VİP</option>
                                                                    <option <?php if ($allUsers[$i]->userRole == 4) {
                                                                        echo "selected";
                                                                    } ?> value="4">Yıllık VİP</option>
                                                                </select>
                                                            </div>
                                                        </div><!--end col-->

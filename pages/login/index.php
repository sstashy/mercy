...
<html lang="tr" data-layout="vertical" data-layout-style="default" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-layout-mode="dark" data-layout-position="fixed"><!-- <html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none"> --><head>
    ...
    <meta content="Deust Checker" name="description">
                            ...
                            <div class="card-body ">
                                <div class="text-center ">
                                    <a class="d-inline-block auth-logo">
                                        <img src="../assets/images/lexas-logo.png" id="logo-login" alt="" height="100">
                                        <style>
                                            #logo-login:hover {
                                                transition: 500ms;
                                                transform: scale(2.5);
                                    ...
                                    <h5 class="text" id="lexas-text">Mercypro'ya tekrardan hoşgeldin!
                                        <style>
                                            #lexas-text:hover {
                                                transition: 500ms;
                                                transform: scale(1.5);
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password" class="form-control" id="password" placeholder="Anahtarınızı giriniz." required="" oninvalid="this.setCustomValidity('Lütfen bir anahtar giriniz.')" oninput="this.setCustomValidity('')">
                                        </div>

                                    

                                        <div class="mt-4">
                                            <button class="btn btn-soft-success w-100" name="loginForm" type="submit">Giriş yap, macelaya atla!</button>
                                        </div>

...
<head>
    <!-- t.me/katana_hack oglım amınaaaa-->
    <meta charset="utf-8" />
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/lexas-logo">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center pt-4">
                            ...
                            <div class="mt-n4">
                                ...
                                <h3 class="text-uppercase">Bir hata oluştu</h3>
                                <a href="index.php" class="btn btn-success"><i class="mdi mdi-home me-1"></i>Eve Dön</a>
                            </div>
                        </div>
                    </div>
                </div>
